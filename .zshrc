...
POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%{%F{black}%K{004}%} $user_symbol%{%b%f%k%F{004}%} %{%f%} "
...
POWERLEVEL9K_OK_ICON_BACKGROUND="black"
POWERLEVEL9K_OK_ICON_FOREGROUND="004"
